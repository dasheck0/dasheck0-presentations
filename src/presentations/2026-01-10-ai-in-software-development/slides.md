...
Prompt → Result → Feedback → Prompt …

**Advantages:**
- Quick corrections possible
- More control throughout the process
- Good for explorative tasks

**Disadvantages:**
- Time-intensive due to constant interaction
- Result heavily depends on the ability to steer the dialog effectively
...
Requirements → Implementation plan → Agent works until completion

**Advantages:**
- No manual effort during execution
- Scalable to complex tasks

**Disadvantages:**
- High upfront effort (requirements, plan)
- Errors only visible at the end
...
<p style="font-size:0.82em;margin-bottom:0.2em">Dialog-based builds competence — Autonomous unfolds its potential only beyond a certain skill level.</p>
...
<svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:400px;display:block">
  ...
  <text x="162" y="46" text-anchor="middle" fill="#8b7ad6" font-size="20" font-weight="bold">💬 Dialog-based</text>
  <text x="522" y="46" text-anchor="middle" fill="#ec4899" font-size="20" font-weight="bold">🤖 Autonomous</text>
  <text x="415" y="408" text-anchor="middle" fill="#aaa" font-size="16">Level of Competence →</text>
  <text x="295" y="220" fill="#ec4899" font-size="14" transform="rotate(-90,290,220)">Threshold</text>
</svg>
</div>
